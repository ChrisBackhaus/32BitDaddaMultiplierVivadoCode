...
HD_PWD='C:/Users/chris/Desktop/32BitDadda/32bitdadda/32bitdadda.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DaddaMultiplier.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DaddaMultiplier.tcl
